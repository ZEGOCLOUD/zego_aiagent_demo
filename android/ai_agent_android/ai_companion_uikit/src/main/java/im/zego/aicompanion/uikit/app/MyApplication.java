...
import im.zego.aicompanion.uikit.ai.ZegoIMKitImpl;
import im.zego.aicompanion.uikit.log.Logger;
...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        Timber.d("init() called with: Build.MANUFACTURER = [" + Build.MANUFACTURER + "], Build.VERSION.SDK_INT = ["
            ...
            + ",ZegoExpressEngine version:" + ZegoExpressEngine.getVersion() + ",ZIM getVersion:" + ZIM.getVersion());
        ...
        // 初始化 AIAgent 服务
        ZegoAIAgentHelper.setImProxy(new ZegoIMKitImpl());

        ZegoAIAgentHelper.initAICompanion(this, appID, appSign, serverSecret, defaultUserInfo.userID,
            defaultUserInfo.userName, defaultUserInfo.userAvatar);
    }
